...
import {  updateSubtypes , deleteUpdateSubtypes, fetchSubtypes } from '../actions/typeActions';
        ...
        var centerText = this.state.currentEdit? 
            ...
            <div className="row border-bottom">
                ...
                <div className="col-sm-3">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="Delete" className='btn-danger' onClick={this.delete}   > 
...
export default connect(mapStateToProps, {updateSubtypes, deleteUpdateSubtypes,fetchSubtypes })(Subtypes);
